        ...
        <div className= 'MainTextSkillsParent' id="Skills">
            ...
            <div className='MainTextSkillsBody'>
                ...
                <div className='MainTextSkillsBodyRight'>
                    ...
                    <span className='MainTextSkillsBodyItem' style={{ left: '73.33%', top: '34%' }}>SQL</span>
                    ...
                    <span className='MainTextSkillsBodyItem' style={{ left: '33.33%', top: '58%' }}>Git</span>
                    <span className='MainTextSkillsBodyItem' style={{ left: '83.33%', top: '66%' }}>JIRA</span>
                    <span className='MainTextSkillsBodyItem' style={{ left: '53.33%', top: '74%' }}>Firebase</span>
